...
{if $contact.contact_type eq 'Household'}
        <div class="action-link">
            <a title='New Relationship' class='add button box-load'  href='{crmURL p='civicrm/profile/create' q="reset=1&snippet=1&context=boxload&gid=16&hid=`$contact.contact_id`"}&width=50%'><span><div class='icon add-icon'></div> Add a Relationship </span></a>
        </div>
{/if}
    </div>
</div>
