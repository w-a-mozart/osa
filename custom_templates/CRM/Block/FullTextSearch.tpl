...
<div class="block-crm">
    ...
    <input type="text" name="text" id='text' value="" style="width: 10em;" class="form-text" />&nbsp;<input type="submit" name="submit" id="fulltext_submit" value="{ts}Go{/ts}" class="form-submit"/ onclick='submitForm();'>
	</div>
