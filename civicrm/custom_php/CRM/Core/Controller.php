...
//    self::invalidKeyCommon();
  ...
  public function invalidKeyRedirect() {
    if ($this->_entryURL) {
      CRM_Core_Session::setStatus(ts('Your browser session has expired and we are unable to complete your request. We have returned you to the initial step so you can complete and resubmit. If you continue to experience difficulties, please contact us for assistance.'));
...
//      self::invalidKeyCommon();
      ...
      watchdog('ahh', '<pre>' . print_r($ahhmsg, TRUE) . '</pre>', array(), WATCHDOG_ERROR);
