...
class CRM_Contribute_Form_Contribution_Confirm extends CRM_Contribute_Form_ContributionBase {
  ...
  public function postProcess() {
    ...
    $contactID = isset($this->_params['contact_id']) ? $this->_params['contact_id'] : $contactID;
    try {
  ...
  protected function processFormSubmission($contactID) {
    ...
    elseif (!empty($this->_membershipContactID) && $contactID != $this->_membershipContactID && !empty($this->_membershipBlock)) {
