  ...
  public function preProcess() {
    ...
    if (!$this->_values) {
      ...
      if (empty($this->_values['is_active'])) {
        if ($this->_id == 1) {
//          CRM_Utils_System::setUFMessage('Membership registration for the upcoming school year is not yet open.  Please check back later.');  ** no type argument
          drupal_set_message('Membership registration for the upcoming school year is not yet open.  Please check back later.', 'warning');
          CRM_Utils_System::redirect('/osa/civicrm/user?reset=1');
        } else {
