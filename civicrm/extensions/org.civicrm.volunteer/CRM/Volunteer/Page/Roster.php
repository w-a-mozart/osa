...
class CRM_Volunteer_Page_Roster extends CRM_Core_Page {
  ...
  private function fetchAssignments(){
    ...
    foreach($volunteerAssignments['values'] as $assignmentKey => &$assignment) {
      ...
      $assignment['role_description'] = $this->project->needs[$needId]['role_description'];
      $assignment['need_description'] = $this->project->needs[$needId]['description'];
      $assignment['credits'] = $this->project->needs[$needId]['duration'];
    }
