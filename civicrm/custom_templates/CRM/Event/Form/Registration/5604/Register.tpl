...
{literal}
<style>
#editrow-custom_212, #helprow-custom_212, .number_of_children-section, .number_of_children_in_your_family-section, .discount-info {
    display: none;
}
input#custom_212 {
    width: 20em;
...
{literal}
<script>
function osa_priceset_logic() {
  var anotherFamily = cj("[name='custom_211']:checked").val();
  if(anotherFamily == 1){
    cj(".number_of_children-section").hide();
    cj("input#custom_212").val('');
    cj("input#price_449").val(cj("input#price_446").val());
    cj("input#price_446").val('');
    cj("#editrow-custom_212").show();
    cj("#helprow-custom_212").show();
    cj(".number_of_children_in_your_family-section").show();
  }
  if(anotherFamily == 0){
    cj("#editrow-custom_212").hide();
    cj("#helprow-custom_212").hide();
    cj(".number_of_children_in_your_family-section").hide();
    cj("input#custom_212").val('-');
    cj("input#price_446").val(cj("input#price_449").val());
    cj("input#price_449").val('');
    cj(".number_of_children-section").show();
  }
}
osa_priceset_logic();

cj("[name='custom_211']").click(function(){
  osa_priceset_logic();
  calcTotal();
});
{/literal}
