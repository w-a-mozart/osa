...
WHERE  id = %1";
  ...
  public static function &stateProvinceForCountry($countryID, $field = 'name') {
    ...
    // put in check to return on invalid country ID. stops log from filling when bots fill in registration page with invalid country
    if (!CRM_Utils_Rule::integer($countryID)) {
      return array();
    }
