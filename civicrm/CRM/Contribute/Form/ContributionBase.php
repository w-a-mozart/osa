  ...
  public function preProcess() {
    ...
    if (!$this->_id) {
      ...
      if (!$pastContributionID) {
        ...
        drupal_goto(CRM_Utils_System::url('civicrm/contribute/transact', 'reset=1&id=' . $pastContributionID));
        return;
  ...
  function buildCustom($id, $name, $viewOnly = FALSE, $onBehalf = FALSE, $fieldTypes = NULL) {
    ...
    if ($id) {
      ...
      if ($fields) {
        ...
        /* don't unset email fields for OSA because we don't collect it
